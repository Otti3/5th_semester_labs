...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_File_reader_t, stringdata0) + ofs), len 
...
void File_reader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<File_reader *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject File_reader::staticMetaObject = { {
    ...
    qt_meta_stringdata_File_reader.offsetsAndSize,
